...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            elarc = RegionalCenter.objects.filter(regional_center__icontains='eastern').first()
            if elarc:
                ...
                elarc_zip_codes = [
                    ...
                    '91110', '91114', '91115', '91116', '91117', '91121', '91123', '91124', '91125',
                    '91126', '91129', '91131', '91175', '91182', '91184', '91185', '91188', '91189',
                    '91199',
                    # Altadena
                    '91001', '91003',
                ...
                self.stdout.write(
                    self.style.SUCCESS(f'✅ Updated Eastern LA Regional Center with {len(elarc_zip_codes)} ZIP codes')
                )
                self.stdout.write(f'ZIP 91101 (Pasadena) included: {"91101" in elarc.zip_codes}')
                self.stdout.write(f'ZIP 91106 (Pasadena) included: {"91106" in elarc.zip_codes}')
            else:
                self.stdout.write(self.style.ERROR('Eastern Los Angeles Regional Center not found'))
