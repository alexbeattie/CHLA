...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not regional_centers.exists():
            self.stdout.write(self.style.ERROR("No regional centers found in database!"))
            return
        ...
        if duplicate_zips:
            self.stdout.write(self.style.ERROR(f"  Duplicate ZIPs: {len(duplicate_zips)}"))
        ...
        if missing_zips:
            self.stdout.write(f"  • Add {len(missing_zips)} missing ZIP codes to appropriate regional centers")
            self.stdout.write(f"  • Run: python3 manage.py audit_zip_coverage --fix")
        if duplicate_zips:
            self.stdout.write(f"  • Remove {len(duplicate_zips)} duplicate ZIP code assignments")
    ...
    def _get_known_la_zips(self):
        ...
        la_zips.update([
            ...
            "90066", "90067", "90068", "90069", "90071", "90077", "90089", "90094",
        ])
        
        # South Bay (902xx-905xx)
        la_zips.update([
            "90201", "90220", "90221", "90222", "90223", "90224", "90230", "90240",
            "90241", "90242", "90245", "90247", "90248", "90249", "90250", "90254",
            "90255", "90260", "90261", "90262", "90265", "90266", "90267", "90270",
            "90272", "90274", "90275", "90277", "90278", "90280", "90290", "90291",
            "90292", "90293", "90301", "90302", "90303", "90304", "90305", "90401",
            "90402", "90403", "90404", "90405", "90501", "90502", "90503", "90504",
            "90505", "90506", "90650", "90660", "90670", "90701", "90703", "90706",
            "90710", "90712", "90713", "90715", "90716", "90717", "90723", "90731",
            "90732", "90740", "90744", "90745", "90746", "90755", "90802", "90803",
            "90804", "90805", "90806", "90807", "90808", "90810", "90813", "90814",
            "90815", "90822", "90831", "90840",
        ])
        
        # San Gabriel Valley (910xx-918xx)
        la_zips.update([
            "91001", "91006", "91007", "91008", "91010", "91011", "91016", "91020",
            "91024", "91030", "91040", "91041", "91042", "91043", "91046", "91101",
            "91103", "91104", "91105", "91106", "91107", "91108", "91201", "91202",
            ...
            "91601", "91602", "91604", "91605", "91606", "91607", "91608", "91702",
    ...
    def _find_duplicates(self, rc_data):
        ...
        return {zip_code: centers for zip_code, centers in zip_to_centers.items() 
                if len(centers) > 1}
    ...
    def _fix_missing_zips(self, missing_zips, regional_centers):
        ...
        for zip_code in missing_zips:
            ...
            if target_rc:
                ...
                added_count += 1
                self.stdout.write(
                    self.style.SUCCESS(f"  ✅ Added {zip_code} to {target_rc.regional_center}")
                )
