#!/usr/bin/env python3
"""
Test if migrations work now by running migrate command.
"""
...
output_file = '/Users/alexbeattie/Developer/CHLA/maplocation/migrate_test_output.txt'
...
with open(output_file, 'w') as f:
    f.write(f"Migration Test - {__import__('datetime').datetime.now()}\n")
    f.write("="*60 + "\n\n")
...
try:
    ...
    log("\n" + "="*60)
    log("RUNNING: python manage.py migrate")
    log("="*60 + "\n")
    ...
    log("\n" + "="*60)
    log("RUNNING: python manage.py showmigrations locations")
    log("="*60 + "\n")
