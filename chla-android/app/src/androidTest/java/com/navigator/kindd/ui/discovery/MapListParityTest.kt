...
import com.navigator.kindd.ui.navigation.KINDDMainNavHost
import com.navigator.kindd.ui.navigation.MainDestinationContent
import com.navigator.kindd.ui.navigation.MainNavActions
...
import com.navigator.kindd.ui.screens.MapMarkerModel
...
class MapListParityTest {
    ...
    fun providerCard_phoneActionIsIndependentAndFiresExactlyOnce() {
        ...
        composeRule.setContent {
            KINDDTheme {
                com.navigator.kindd.ui.providers.ProviderCard(
                    provider = provider,
